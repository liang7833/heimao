...
class StrategyConfigDialog:
    ...
    def _create_position_tab(self):
        ...
        self._create_param_row(frame, "position", "add_on_profit", "盈利加仓", "bool", None, None, "是否在盈利时加仓")
    ...
    def _create_strategy_tab(self):
        """创建策略参数标签页"""
        frame = ttk.Frame(self.notebook, padding="15")
        self.notebook.add(frame, text="9. 策略参数")
        
        ttk.Label(frame, text="【策略参数】", font=("微软雅黑", 11, "bold")).pack(anchor=tk.W, pady=(0, 10))
...
"""
    ...
    def _get_current_ai_strategy_config(self):
        ...
        try:
            ...
            default_config["basic"] = {
                "LEVERAGE": getattr(StrategyConfig, "LEVERAGE", 10),
                "POSITION_MULTIPLIER": getattr(StrategyConfig, "POSITION_MULTIPLIER", 1.2),
    ...
    def _apply_ai_strategy_preset(self, preset_name):
        ...
        self._load_ai_strategy_config_dict(preset_config)
        print(f"已应用预设: {preset_name}")
...
'''
            ...
            config_content = config_content.format(
                ...
                POSITION_MULTIPLIER=basic.get("POSITION_MULTIPLIER", 1.2),
